package com.giovannip.noticeme.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.giovannip.noticeme.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.giovannip.noticeme.repository.UserRepository.USERS_BY_EMAIL_CACHE);
