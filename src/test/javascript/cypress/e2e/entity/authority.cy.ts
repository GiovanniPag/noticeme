...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'a6c83274-ec5f-4bd9-a2d7-49cd222b2abd' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('5e962211-4c9f-40b8-87cd-23d23aaf6ad5');
      cy.get(`[data-cy="name"]`).should('have.value', '5e962211-4c9f-40b8-87cd-23d23aaf6ad5');
