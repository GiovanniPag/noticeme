...
import static com.giovannip.noticeme.domain.TagAsserts.*;
...
class TagResourceIT {
    ...
    void putExistingTag() throws Exception {
        ...
        updatedTag.tagName(UPDATED_TAG_NAME).color(UPDATED_COLOR);
    ...
    void fullUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.tagName(UPDATED_TAG_NAME).color(UPDATED_COLOR);
